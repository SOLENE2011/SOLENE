...
function goodsdelete(goods_num){
	...
	document.goodsform.action="/SOLENE/GoodsDelete.ag?goods_num="+goods_num;
...
function goodsmodify(goods_num){
	...
	document.goodsform.action="/SOLENE/GoodsModify.ag?goods_num="+goods_num;
	document.goodsform.submit();
				...
				<table border="0" width="80%">
					...
					<tr>
						<td>
							<p align="right">
								<font size="2">
									<a href="/SOLENE/GoodsAdd.ag">상품 등록</a>
								</font>
							</p>
						</td>
					</tr>
						...
						<td>
							<form name="goodsform" method="post">
								<table border="1">
									<tr>
										<td width="50">
											<p align="center"><font size="2">번 호</font></p>
										</td>
										<td width="141">
											<p align="center"><font size="2">카테 고리</font></p>
										</td>
										<td width="100">
											<p align="center"><font size="2">사 진</font></p>
										</td>
										<td width="141">
											<p align="center"><font size="2">상 품 명</font></p>
										</td>
										<td width="141">
											<p align="center"><font size="2">단 가</font></p>
										</td>
										<td width="80">
											<p align="center"><font size="2">수 량</font></p>
										</td>
										<td width="141">
											<p align="center"><font size="2">등록 일자</font></p>
										</td>
										<td width="100">
									...
									<tr>
										...
										<td>
											<p align="center">
												<img src="/SOLENE/upload/<%=agb.getGOODS_IMAGE().split(",")[0] %>" width="50" height="50" border="0">
											</p>
										</td>
										<td>
											<p align="center">
