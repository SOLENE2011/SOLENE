		...
		<tr>
			<td colspan="2">
				...
				<table width="80%" border="0">
					<form name="goodsform" action="/SOLENE/GoodsAddAction.ag" method="post" enctype="multipart/form-data">
							...
							<tr>
								<td height="331">
									<table border="1" align="center" width="558">
										<tr>
											...
											<td width="346" height="30">
												<select name="goods_category" size="1">
													<option value="outwear" selected>아웃 웨어</option>
										...
										<tr>
											<td>
												<p align="center"><font size="2">상품 이름</font>
												</p>
											</td>
											<td>
										...
										<tr>
											<td>
												<p align="center"><font size="2">판매가</font>
												</p>
											</td>
											<td>
										...
										<tr>
											<td>
												<p align="center"><font size="2">색깔</font>
												</p>
											</td>
											<td>
												<input type="text" name="goods_color">
											</td>
										</tr>
										<tr>
											<td>
												<p align="center"><font size="2">수량</font>
												</p>
											</td>
											<td>
										...
										<tr>
											<td>
												<p align="center"><font size="2">사이즈</font>
												</p>
											</td>
											<td>
										...
										<tr>
											<td width="196">
												<p align="center"><font size="2">제품 정보</font>
												</p>
											</td>
											<td width="346">
										...
										<tr>
											<td>
												<p align="center"><font size="2">메인 홈페이지(gif)</font>
												</p>
											</td>
											<td>
										...
										<tr>
											<td>
												<p align="center"><font size="2">제품 이미지1(gif)</font>
												</p>
											</td>
											<td>
											...
											<td>
												<p align="center"><font size="2">제품 이미지2(gif)</font>
												</p>
											</td>
											<td>
										...
										<tr>
											<td>
												<p align="center"><font size="2">제품 이미지3(gif)</font>
												</p>
											</td>
											<td>
