...
<form method="post" action="/SOLENE/logon2/modifyPro.do" name="userinput" onsubmit="return checkIt()">
...
<table width=600 border=1 cellspacing=0 cellpadding=3 align=center>
	...
	<tr>
		<td colspan=2 align=center bgcolor="${value_c}">
			...
			<input type="button" value="취소"	 onclick="document.location.href='/SOLENE/logon2/main.do'">
		</td>
	</tr>
</table>
</form>
