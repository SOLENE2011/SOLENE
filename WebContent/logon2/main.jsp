...
<table width="500" cellpadding="0" align="center" border="1">
	...
	<form name="inform" method="post" action="/SOLENE/logon2/loginPro.do">
	...
	<tr>
		<td colspan="3" bgcolor="${title_c}" align="center">
			...
			<input type="button" value="회원가입"
				onclick="document.location.href='/SOLENE/logon2/inputForm.do'">
		</td>
		</form>
		</tr>
		</table>
...
<c:if test="${!empty sessionScope.memId}">
	<table width="500" cellpadding="0" cellspacing="0" align="center" border="1">
		...
		<tr>
			...
			방문하셨습니다.
		<form method="post" action="/SOLENE/logon2/logout.do">
			<input type="submit" value="로그아웃">
				<input type="button" value="회원정보변경"
					onclick="document.location.href='/SOLENE/logon2/modify.do'">
		</form>
			</td>
		</tr>
