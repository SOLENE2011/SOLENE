...
function openConfirmid(userinput){
	...
	url = "/SOLENE/logon2/confirmId.do?id="+userinput.id.value;
...
<form method="post" action="/SOLENE/logon2/inputPro.do" name="userinput" 
...
<table width="600" border="1" cellspacing="0" cellpadding="3" align="center">
	...
	<tr>
		...
		<td width="400">
			<input type="text" name="zipcode" maxlength="7" />
	...
	<tr>
		<td width="200">주소</td>
		<td width="400">
			<input type="text" name="address" size="40" maxlength="70" />
		</td>
	</tr>
	...
	<tr>
		<td colspan="2"	align="center" bgcolor="${value_c}">
			...
			<input type="button" value="가입안함"
				onclick="document.location.href='/SOLENE/logon2/main.do'">
		</td>
	</tr>
</table>
</form>
