...
<%
	...
	/* String id = (String) session.getAttribute("memId"); 하는이유! */
	try{
%>
<div id="joinWrap">
	<h1>Modify</h1>
...
<table>
			...
			<tr>
				...
				<td>
					...
					<% } %>
					<!-- Email은 필수사항이 아니기 때문에 null값이면 빈칸으로 두고 값이 있다면 가져온다! -->
				</td>
			</tr>
			<tr>
				<th>Blog</th>
